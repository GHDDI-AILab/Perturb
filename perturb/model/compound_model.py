...
class Transformer4Cmpd(nn.Module):
    def __init__(
        self,
        ntoken: int,
        d_model: int,
        ...
        self.cmpd_encoder = CompoundEncoder(self.atom_feature_dims, d_model)
...
class CompoundEncoder(nn.Module):
    ...
    def forward(self, x: Tensor, device: torch.device) -> Tensor:
        ...
        for data in data_list:
            ...
            x_embedding_act = self.act(x_embedding_mlp)
            x_embeddings.append(x_embedding_act)
